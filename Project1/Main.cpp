...
int main(){
  ...
  // Book test;
  // test.setTitle("Illusion");
  // test.setAuthor("Emily French");
  // test.setISBN(9810178221);
  // //test.setIcon(12822432432);
  // test.setPrice(33.16);
  // //test.setKeywords("Horse Racing");
  // test.setBlurb("Illusion by Emily French released on Dec 25, 1995 is available now for purchase.");
